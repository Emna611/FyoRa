...
<title>Modèle Bon de Commande Produits</title>
        ...
        <li id="cid_1" class="form-input-wide" data-type="control_head">
            <div class="form-header-group header-large">
                <div class="header-text httal htvam">
                    <h1 id="header_1" class="form-header" data-component="header">Bon de Commande de Produit</h1>
                </div>
            </div>
        </li>
